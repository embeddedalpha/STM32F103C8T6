...
void BNO055_GET_Quaternion_DATA(void)
{
	...
	QUA_W = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	QUA_X = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	QUA_Y = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
	QUA_Z = (BNO055_Buffer[7] << 8) | BNO055_Buffer[6];
...
void BNO055_GET_Euler_DATA(void)
{
	...
	RAW = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	PITCH = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	ROLL = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
...
void BNO055_GET_Gravity_Vector_DATA(void)
{
	...
	GRV_X = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	GRV_Y = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	GRV_Z = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
...
void BNO055_GET_Linear_Acceleration_DATA(void)
{
	...
	LIN_X = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	LIN_Y = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	LIN_Z = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
...
void BNO055_GET_GYRO_DATA(void)
{
	...
	GYRO_X = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	GYRO_Y = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	GYRO_Z = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
...
void BNO055_GET_ACCL_DATA(void)
{
	...
	ACCL_X = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	ACCL_Y = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	ACCL_Z = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
...
void BNO055_GET_MAG_DATA(void)
{
	...
	MAG_X = (BNO055_Buffer[1] << 8) | BNO055_Buffer[0];
	MAG_Y = (BNO055_Buffer[3] << 8) | BNO055_Buffer[2];
	MAG_Z = (BNO055_Buffer[5] << 8) | BNO055_Buffer[4];
